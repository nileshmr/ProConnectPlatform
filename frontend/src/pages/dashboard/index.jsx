        ...
        <DashboardLayout>
          ...
          <div className={styles.scrollComponent}>
            ...
            <div className={styles.createPostContainer}>
              ...
              src={`${BASE_URL}/${authState.user?.userId?.profilePicture}`} alt="" />

              <textarea  onChange={(e) => 
                setPostContent(e.target.value)
              } value={postContent} placeholder={"What's is in your mind?"} className={styles.textAreaOfContent} name="" id=""></textarea>
                            ...
                            <div>
                              ...
                              <div className={styles.optionsContainer}>
                               ...
                               <div onClick={() => {
                                  ...
                                  const url = encodeURIComponent("gpnacollege.in");
