...
export default function ProfilePage() {
   ...
   const handleWorkInputChange = (e) => {
    ...
    const updateProfileData = async () => {
        ...
        const response = await clientServer.post("/update_profile_data", { token: localStorage.getItem("token"),
        bio: userProfile.bio,
            ...
            <div className={styles.container}>
             ...
             <div className={styles.profileContainer_details}>
                ...
                <div style={{flex:"0.8"}}>
                    ...
                    <div style={{flex:"0.2", width: "fit-content", alignItems: "center", gap: "1.2rem"}}>
